...
//how to create class
class Employee {
    // public employeeName:string;//add public access modifier
        // private employeeName:string;//add private access modifier 
        protected employeeName:string;//add protected access modifier public
...
emp1.greet();
 ...
 class Manager extends Employee{
     constructor(managerName:string){//constructor overriding
     super(managerName);
     }
     delegateWork(){
 ...
 let m1= new Manager('Bruce');//child class name
